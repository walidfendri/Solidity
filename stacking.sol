...
contract SimpleStaking {
    ...
    /// onds amount of seconds to add to the initial timestamp i.e. we are essemtially creating the minimum staking period here
    ...
    function stake(IERC20 token, uint256 amount) public timestampIsSet  {
